...
keys = {
  ...
  b"CustomVolumeMultiplier": [TxType.PERSISTENT],
  b"CustomBrightnessBase": [TxType.PERSISTENT],
  b"CustomBrightnessIncrement": [TxType.PERSISTENT],
  b"CustomCameraOffset": [TxType.PERSISTENT],
  b"CustomAllowGas": [TxType.PERSISTENT],
  b"CustomGasSetSpeed": [TxType.PERSISTENT],
