...
keys = {
  ...
  b"VolumeMultiplier": [TxType.PERSISTENT],
  b"BrightnessBase": [TxType.PERSISTENT],
  b"BrightnessIncrement": [TxType.PERSISTENT],
  b"CameraOffset": [TxType.PERSISTENT],
  b"AllowGas": [TxType.PERSISTENT],
  b"GasSetSpeed": [TxType.PERSISTENT],
